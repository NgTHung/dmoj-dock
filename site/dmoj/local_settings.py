...
SECRET_KEY = 'v^ukebzvrn(4#)b)z8ky18*l^uhg!5lfo7af!11sgw0155r'
...
EVENT_DAEMON_GET = 'ws://127.0.0.1:1510/'
...
EVENT_DAEMON_GET = 'ws://dmojpblk.eu-ggqrtyuigfhs.dopraxrocks.net/event/'
EVENT_DAEMON_GET_SSL = 'wss://dmojpblk.eu-ggqrtyuigfhs.dopraxrocks.net/event/'  # Optional
